...
const TABS: { id: Tab; label: string; icon: React.ReactNode }[] = [
  ...
  { id: 'profile', label: 'Dash', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg> },
];
          ...
          {TABS.map(tab => {
            ...
            return (
              <button
                ...
                aria-label={tab.label === 'Dash' ? 'Dashboard' : tab.label}
              >
